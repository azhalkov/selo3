...
from .views import ZadachaView
from  . import views

urlpatterns = [
    # path('', views.mydelo, name='delo'),
    path('newdelo/', ZadachaView.as_view(template_name='delo/delo_form.html'), name='newdelo'),
    path('', views.ZadachaListView.as_view(), name='delo'),
